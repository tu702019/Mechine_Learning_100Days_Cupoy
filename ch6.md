...
## 第1題
**題目：** 下列哪一個選項最能完成以下陳述？請解釋。與較低風險趨避程度的投資者相比，具有較高風險趨避程度的投資者會要求
a. 具有較高風險溢價的投資組合。
...
## 第3題
**題目：** 如果投資者感知到股票市場的波動性更高，你認為股票的均衡預期回報會發生什麼變化？將你的答案與方程式6.7聯繫起來。
...
## 第4題
**題目：** 考慮一個風險投資組合。從該投資組合獲得的年終現金流將是$70,000或$200,000，各有0.5的相等概率。無風險國庫券的替代投資每年支付2%。
...
## 第5題
**題目：** 考慮一個提供7%預期回報率和18%標準差的投資組合。國庫券提供2%的無風險回報率。風險趨避程度的最大水平是多少，使得風險投資組合仍然優於國庫券？
...
## 第6題
**題目：** 在預期回報-標準差平面上繪製對應於效用水平0.02、風險趨避係數為3的投資者的無差異曲線。（提示：選擇幾個可能的標準差，範圍從0到0.25，找出提供0.02效用水平的預期回報率。然後繪製由此得出的預期回報-標準差點。）
